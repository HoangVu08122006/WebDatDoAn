<?php
/**
 * US09: Danh sách người dùng (Admin)
 */
?>
<!DOCTYPE html>
<html lang="vi">
                ...
                <tbody>
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <span style="background: <?php echo $user['role'] === 'admin' ? '#667eea' : '#95a5a6'; ?>; color: white; padding: 5px 10px; border-radius: 3px;">
                            ...
                            <td>
                                <div class="actions">
                                    <a href="?c=adminUser&a=edit&id=<?php echo $user['id']; ?>" class="btn">✏️ Sửa</a>
                                    <a href="?c=adminUser&a=delete&id=<?php echo $user['id']; ?>" class="btn btn-danger" onclick="return confirm('Bạn chắc chắn muốn xóa?')">🗑️ Xóa</a>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; ?>
